		...
		<div class="container">
			<div class="row ">
				<div id="procesar-pago" class="shopping-cart opcionFase1">
					...
					<!-- ============================================== CONTENT BOLSA  ============================================== -->
					<div class="opcionesDespachoIzq">
						<form class="formDespacho1" role="form" method="post"> 
							
							<div class="">
								<div class="tituloForm1" >
								Elige tus opciones de Despacho
								</div>
								<div class="form-group">
									<div class="subtituloForm">Selecciona el Departamento, Provincia y Distrito donde quieres despachar o retirar tus productos.</div>
								</div>
								<div class="contieneNumberAndAcompaña">
									<div class="numberCircle">1</div><div class="acompañaCircle">Ingrese Dirección</div>
								</div>
								<div class="tituloCombo">Departamento</div>
								<div>

									<select class="comboDepartamento">
										<option>Lima</option>
										<option selected="selected">Departamento</option>
										<option>Tumbes</option>
										<option>La Libertad</option>
										<option>Arequiá</option>
									</select>
								</div>
								<div class="tituloCombo">Provincia</div>
								<div >

									<select class="comboProvincia">
										<option>Lima</option>
										<option selected="selected">DepartamentoSSSSSSSSSSSSSSSSSSSSSSSSSS</option>
										<option>Tumbes</option>
										<option>La Libertad</option>
										<option>Arequiá</option>
									</select>
								</div>
								<div class="tituloCombo">Distrito</div>
								<div>

									<select class="comboDistrito">
										<option>Lima</option>
										<option selected="selected">Departamento</option>
										<option>Tumbes</option>
										<option>La Libertad</option>
