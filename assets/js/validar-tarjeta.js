var cardValidator = function(e) {
    ...
    var a = {};
    return r.m = e, r.c = a, r.d = function(e, a, t) { r.o(e, a) || Object.defineProperty(e, a, { configurable: !1, enumerable: !0, get: t }) }, r.n = function(e) { var a = e && e.__esModule ? function() { return e.default } : function() { return e }; return r.d(a, "a", a), a }, r.o = function(e, r) { return Object.prototype.hasOwnProperty.call(e, r) }, r.p = "/assets", r(r.s = 4)
}([function(e, r, a) {
    "use strict";
    ...
    function n(e) {
        ...
        var n = a.reduce(function(e, r) { return parseInt(e) + parseInt(r) }),
            i = t.map(function(e) { var r = 2 * e; if (r > 9) { var a = r.toString().split(""); return parseInt(a[0]) + parseInt(a[1]) } return r }).reduce(function(e, r) { return parseInt(e) + parseInt(r) }),
            d = (n + i).toString();
        if ("0" === d.charAt(d.length - 1)) return !0
    }
    Object.defineProperty(r, "__esModule", { value: !0 }), r.validateCard = r.predictCard = r.defaults = r.init = void 0;
    var i = a(1),
        d = t(i),
        s = a(2),
        u = t(s),
        o = a(3),
        c = { querySelectors: { logo: "#card-logo", label: "#card-label", cardNumber: "#card_number" }, errorMessage: "Tarjeta invalida" },
        m = function() {
            var e = document.querySelector(c.querySelectors.logo),
                r = document.querySelector(c.querySelectors.cardNumber);
            r && e && r.addEventListener("input", function() {
        ...
        g = function(e) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "unknown";
