...
<div class="body-content">
	...
	<div class="">
    <p>
    Última actualización: 03 de enero de 2022 <br>
...
Usamos sus datos personales para proporcionar y mejorar el Servicio. Al usar el Servicio, acepta la recopilación y el uso de información de acuerdo con esta Política de privacidad. Esta Política de privacidad se ha creado con la ayuda de la Plantilla de política de privacidad.
</p>
...
Usted se refiere a la persona que accede o utiliza el Servicio, o la empresa u otra entidad legal en nombre de la cual dicha persona accede o utiliza el Servicio, según corresponda.
	...
	<h2 class="heading-title">Recopilación y uso de sus datos personales</h2>
...
Cookies o Cookies del Navegador. Una cookie es un pequeño archivo que se coloca en su dispositivo. Puede indicar a su navegador que rechace todas las cookies o que indique cuándo se envía una cookie. Sin embargo, si no acepta las Cookies, es posible que no pueda utilizar algunas partes de nuestro Servicio. A menos que haya ajustado la configuración de su navegador para que rechace las Cookies, nuestro Servicio puede usar Cookies.
...
Las cookies pueden ser cookies "persistentes" o de "sesión". Las cookies persistentes permanecen en su computadora personal o dispositivo móvil cuando se desconecta, mientras que las cookies de sesión se eliminan tan pronto como cierra su navegador web. Más información sobre cookies: Uso de Cookies por parte de Free Política de Privacidad.
...
<h2 class="header-title">Contáctenos</h2>
		<p>Si tiene alguna pregunta sobre esta Política de privacidad, puede contactarnos:
Al visitar esta página en nuestro sitio web:<a href="politicasPrivacidad.php" class='contact-form'>Politicas de Privacidad</a></p>
	</div>
</div>			</div><!-- /.row -->
		</div><!-- /.sigin-in-->
		<!-- ============================================== BRANDS CAROUSEL ============================================== -->
