        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
          ...
          <div id="hero">
            <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
              <div class="item" style="background-image: url(image/FotosDanielcalato/Banners_verano.jpg);">
                <!--- fondo de seccion -->
              ...
              <div class="item" style="background-image: url(image/FotosDanielcalato/Banners_verano2.jpg);">
                <!--- fondo de seccion -->
                <div class="container-fluid">
                  <div class="caption bg-color vertical-center text-left">
                          ...
                          <div class="cart clearfix animate-effect ">
                            <div class="action ">
                              <ul class="list-unstyled">
                                ...
                                <li class="lnk wishlist"> <a data-toggle="tooltip" class="add-to-cart agregar-deseos" type="button" title="Deseo"> <i class="icon fa fa-heart"></i> </a> </li>
                              </ul>
                            </div>
                            <!-- /.action -->
                          </div>
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              ...
                              <li class="lnk wishlist"> <a class="add-to-cart agregar-deseos" href="detail.html" title="Lista de Deseos"> <i class="icon fa fa-heart"></i> </a> </li>
                            </ul>
                          </div>
                          <!-- /.action -->
                        </div>
                  ...
                  <div class="strip strip-text">
                    <div class="strip-inner">
                      <h2 class="text-right">Lo nuevo para este verano<br>
                        <span class="shopping-needs">Hasta 20% de descuento en polos y vestidos</span>
                      </h2>
                    </div>
                  </div>
                  <div class="new-label">
