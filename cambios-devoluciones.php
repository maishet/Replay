    ...
    <div class="container">
      <div class="breadcrumb-inner">
        <ul class="list-inline list-unstyled">
          ...
          <li class='active'>Cambios de Devoluciones</li>
        </ul>
    ...
    <div class="container">
      <div class="checkout-box faq-page">
        <div class="row margen">
          <div class="col-md-12">
            <h2 class="heading-title">¿Como realizar el cambio o devolución de un producto?</h2>
            <div class="contenedorAtencion">
              <div class="part1">Replay</div>
              <div class="part2">+(51) 954 433 442</div>
              <div class="part3">Tienes 120 días a partir de la fecha de compra</div>
            </div>
                ...
                <div class="panel-heading">
                  <h4 class="unicase-checkout-title">
                    <a data-toggle="collapse" class=" " data-parent="#accordion" href="#collapseOne">
                      <span>1</span>¿A dónde debes acercarte?
                    </a>
                  </h4>
                </div>
                <!-- panel-heading -->
                ...
                <div class="panel-heading">
                  <h4 class="unicase-checkout-title">
                    <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseThree">
                      <span>3</span>Es importante conocer
                    </a>
                  </h4>
                </div>
                ...
                <div class="panel-heading">
                  <h4 class="unicase-checkout-title">
                    <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseFour">
                      <span>4</span>¿Cómo realizar el cambio o devolución de un producto?
                    </a>
                  </h4>
                </div>
