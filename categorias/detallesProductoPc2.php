...
<head>
  ...
  <title>Replay | HUAWEI LAPTOP MATEBOOK</title>
            ...
            <div id="divproductodetalle" class="row">
                  ...
                  <div id="owl-single-product">
                    <div class="single-product-gallery-item" id="slide1">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Computadoras/Compu2/1.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Computadoras/Compu2/1.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide2">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Computadoras/Compu2/2.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Computadoras/Compu2/2.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide3">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Computadoras/Compu2/3.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Computadoras/Compu2/3.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->
              ...
              <div class='col-sm-12 col-md-8 col-lg-8 product-info-block'>
                <div class="product-info">
                  <h1 class="name">ZenBook 14 UM425 Ryzen 5 5500U 14'' FHD 512GB SSD 8GB RAM</h1>
                      ...
                      <div class="stock-container info-container m-t-10 caracteristicas-cont">
                        ...
                        <div class="description-container m-t-20">
                          <ul class="caracteristicas">
                            <li>Procesador: <span> AMD Ryzen™ 5 3500U</span></li>
                            <li>Modelo tarjeta de video: <span>Intel UHD Ghaphics (Integrada)</span></li>
                            <li>Tamaño de la pantalla: <span> 14 pulgadas </span></li>
                            <li>Disco duro: <span> 1TB</span></li>
                            <li>Disco duro sólido: <span>256GB</span></li>
                      ...
                      <div class="price-container quantity-container info-container precio-cant">
                        <div>
                          ...
                          <div class="precio">
                            ...
                            <div class="price-box">
                              <span class="price-strike">S/.4699.00</span>
                            </div>
                          </div>
                ...
                <div class="tabs contenedor-descripcion" id="description">
                  ...
                  <div class="especificaciones-informacion tabs-content">
                    ...
                    <div class="informacion-producto tabs-panel " id="tab2">
                      ...
                      <p>La Huawei MateBook D 14 cuenta con una preciosa pantalla IPS de 1920 x 1080 px y biseles
                        reducidos. Procesador AMD Ryzen 5 3500U , 8GB de RAM y almacenamiento en estado sólido de 512GB
                      </p>
