...
<head>
  ...
  <title>Replay | Audifonos Gamer Cybertel Xtreme</title>
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="Gallery" href="../image/Tecnologia/Audifonos/Audifono2/Frente.jpg">
                    <img class="img-responsive" alt="" src="../assets/images/blank.gif" data-echo="../image/Tecnologia/Audifonos/Audifono2/Frente.jpg" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide2">
                <a data-lightbox="image-1" data-title="Gallery" href="../image/Tecnologia/Audifonos/Audifono2/caja.jpg">
                    <img class="img-responsive" alt="" src="../assets/images/blank.gif" data-echo="../image/Tecnologia/Audifonos/Audifono2/caja.jpg" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide3">
                <a data-lightbox="image-1" data-title="Gallery" href="../image/Tecnologia/Audifonos/Audifono2/micro.jpg">
                    <img class="img-responsive" alt="" src="../assets/images/blank.gif" data-echo="../image/Tecnologia/Audifonos/Audifono2/micro.jpg" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide4">
                <a data-lightbox="image-1" data-title="Gallery" href="../image/Tecnologia/Audifonos/Audifono2/Costado.jpg">
                    <img class="img-responsive" alt="" src="../assets/images/blank.gif" data-echo="../image/Tecnologia/Audifonos/Audifono2/Costado.jpg" />
                </a>
            </div><!-- /.single-product-gallery-item -->
            ...
            <div id="owl-single-product-thumbnails">
                ...
                <div class="item">
					...
					<div class='col-sm-12 col-md-8 col-lg-8 product-info-block'>
						<div class="product-info">
							<h1 class="name">Audifonos Gamer Cybertel Xtreme</h1>
              ...
              <div class="contenedor-detalles"> 
                  ...
                  <div class="stock-container info-container m-t-10 caracteristicas-cont">
                    ...
                    <div class="description-container m-t-20">
                      <ul class="caracteristicas">
                        ...
                        <li>Garantía:<span>30 días</span></li>
                        <li>Marca:<span> CYBERTEL</span></li>
                        <li>Modelo:<span> XTREME CYB HG502</span></li>
                        <li>Peso:<span>800 gr</span></li>
                        <li>Incluye:<span>1 Audifonos Gamer Cybertel Xtreme con Microfono Flexible RGB</span></li>
                      </ul>
                ...
                <div class="price-container quantity-container info-container precio-cant">
                  <div>
                    ...
                    <div class="precio">
                      ...
                      <div class="price-box">
                        <span class="price-strike">S/.89.00</span>
                      </div>
                    </div>
                      ...
                      <div class="qty-count">
                        <div class="cart-quantity">
                          <div class="quant-input cantidad">
                                     <div class="arrows">
                                      <div class="arrow plus gradient" onclick="sumar()"><span class="ir"><i class="icon fa fa-sort-asc"></i></span></div>
                                      <div class="arrow minus gradient" onclick="restar()"><span class="ir"><i class="icon fa fa-sort-desc"></i></span></div>
                                    </div>
                ...
                <div class="quantity-container info-container botones-detalles">
                    <div class="">
                      <a class="btn  btn-agregar" data-id="16"><i class="fa fa-shopping-cart inner-right-vs"></i> AGREGAR AL CARRITO</a>
                    </div>
                    <div class="">
                ...
                <div class="especificaciones-informacion tabs-content">
                      ...
                      <tr>
                        <td>Modelo</td>
                        <td>MECYBHG502RGBAU</td>
                      </tr>
                      <tr>
                        <td>Tipo  </td>
                        <td>Audífonos vincha</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Salida auxiliar de 3.5 mm</td>
                        <td>No</td>
                      </tr>
                      <tr>
                        <td>Auricular</td>
                        <td>Auriculares on ear</td>
                      </tr> 
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>12 meses por fallas de fábrica</td>
                      </tr> 
                    </table>
									</div>
                  <div class="informacion-producto tabs-panel " id="tab2" >
                    ...
                    <p>Xtreme - CYB HG502
                      ...
                      Auricular Gamer con Micrófono.
                      
                      Conector Jack de 3.5 mm para Audio.
                      
                      Iluminación LED RGB
                      
                      Conector USB para el Encendido de Luces.
                      
                      Micrófono Flexible.
                      
                      Control de Volumen en Orejera.
                      
                      Almohadillas de Cuero.
                      
                      Banda Protectora de Cuero.
                      ...
                      Garantía: 30 días después de recibir el producto, por defectos de fábrica, el producto debe ser devuelto en su empaque original y con todos sus accesorios.
                    </p>
                    ...
                    <div class="m-t-20">
                      ...
                      <div class="comentario">
                        ...
                        <div class="descripcion">
                          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. fugit quos tenetur, voluptates debitis 
