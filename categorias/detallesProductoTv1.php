...
<head>
  ...
  <title>Replay | TELEVISOR SAMSUNG CRYSTAL</title>
            ...
            <div id="divproductodetalle" class="row">
                  ...
                  <div id="owl-single-product">
                    <div class="single-product-gallery-item" id="slide1">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Televisores/Tv1/frente.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Televisores/Tv1/frente.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide2">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Televisores/Tv1/lado derecho.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Televisores/Tv1/lado derecho.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->
                    <div class="single-product-gallery-item" id="slide3">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Televisores/Tv1/lado derecho.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Televisores/Tv1/arriba.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->
                    <div class="single-product-gallery-item" id="slide4">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Televisores/Tv1/lado izquierdo.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Televisores/Tv1/lado izquierdo.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->
              ...
              <div class='col-sm-12 col-md-8 col-lg-8 product-info-block'>
                <div class="product-info">
                  <h1 class="name">TELEVISOR SAMSUNG CRYSTAL ULTRA HD 4K 55''</h1>
                  ...
                  <div class="contenedor-detalles">
                      ...
                      <div class="stock-container info-container m-t-10 caracteristicas-cont">
                        ...
                        <div class="description-container m-t-20">
                          <ul class="caracteristicas">
                            <li>Expresión de Color:<span>optimizada</span></li>
                            <li>Diseño: <span>Sin bordes</span></li>
                            <li>Interacción: <span> Toca y Comparte</span></li>
                            <li>Disco duro: <span> 200GB</span></li>
                    ...
                    <div class="contenedor2">
                      ...
                      <div class="quantity-container info-container botones-detalles">
                        <div class="">
                          <a class="btn  btn-agregar" data-id="9"><i class="fa fa-shopping-cart inner-right-vs"></i> AGREGAR AL
                            CARRITO</a>
                        </div>
                        <div class="">
                ...
                <div class="tabs contenedor-descripcion" id="description">
                  ...
                  <div class="especificaciones-informacion tabs-content">
                    ...
                    <div class="informacion-producto tabs-panel " id="tab2">
                      <h3>Televisor UN55AU7000GXPE de Samsung</h3>
                      <p>Televisor UN55AU7000GXPE de Samsung. Sumérgete en una experiencia 4K inteligente. Movimiento
                        suave para una imagen clara. Más pantalla, menos bisel.
                      </p>
