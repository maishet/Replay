...
<head>
  ...
  <title>Replay | IdeaCentre AIO</title>
            ...
            <div id="divproductodetalle" class="row">
                  ...
                  <div id="owl-single-product">
                    <div class="single-product-gallery-item" id="slide1">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Computadoras/Compu1/1.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Computadoras/Compu1/1.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide2">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Computadoras/Compu1/2.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Computadoras/Compu1/2.jpg"/>
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide3">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Computadoras/Compu1/3.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Computadoras/Compu1/3.jpg"/>
                      </a>
                    </div><!-- /.single-product-gallery-item -->
              ...
              <div class='col-sm-12 col-md-8 col-lg-8 product-info-block'>
                <div class="product-info">
                  <h1 class="name">IdeaCentre AIO 3i Intel Core i3 23.8" Full HD</h1>
                  ...
                  <div class="contenedor-detalles">
                      ...
                      <div class="stock-container info-container m-t-10 caracteristicas-cont">
                        ...
                        <div class="description-container m-t-20">
                          <ul class="caracteristicas">
                            <li>Procesador: <span>Intel Core i3</span></li>
                            <li>Modelo tarjeta de video: <span>Intel UHD Ghaphics (Integrada)</span></li>
                            <li>Tamaño de la pantalla: <span> 23.8 pulgadas </span></li>
                    ...
                    <div class="contenedor2">
                      ...
                      <div class="price-container quantity-container info-container precio-cant">
                        <div>
                          ...
                          <div class="precio">
                            ...
                            <div class="price-box">
                              <span class="price-strike">S/.2099.00</span>
                            </div>
                          </div>
                      ...
                      <div class="quantity-container info-container botones-detalles">
                        <div class="">
                          <a class="btn  btn-agregar" data-id="10"><i class="fa fa-shopping-cart inner-right-vs"></i> AGREGAR AL
                            CARRITO</a>
                        </div>
                        <div class="">
                ...
                <div class="tabs contenedor-descripcion" id="description">
                  ...
                  <div class="especificaciones-informacion tabs-content">
                    ...
                    <div class="informacion-producto tabs-panel " id="tab2">
                      ...
                      <p>IdeaCentre AIO 3i (24") es impecable y elegante. Con su soporte simplificado y la pantalla casi
                        sin bordes de 60,45cm (23,8”), se encarga de todo de forma rápida y fluida. Cuenta con
                        procesadores Intel® Core™ de 10.a generación con una memoria y almacenamiento resistentes que
                        también ahorran espacio. Disponible con pantalla táctil y tarjeta gráfica independiente
                        opcionales.
                      </p>
