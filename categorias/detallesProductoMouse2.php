...
<head>
  ...
  <title>Replay | MOUSE LOGITECH G203 RGB</title>
            ...
            <div id="divproductodetalle" class="row">
                  ...
                  <div id="owl-single-product">
                    <div class="single-product-gallery-item" id="slide1">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Mouse/Mouse2/frente.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Mouse/Mouse2/frente.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide2">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Mouse/Mouse2/lado_arriba.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Mouse/Mouse2/lado_arriba.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide3">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Mouse/Mouse2/lado_izquierdo.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Mouse/Mouse2/lado_izquierdo.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->
              ...
              <div class='col-sm-12 col-md-8 col-lg-8 product-info-block'>
                <div class="product-info">
                  <h1 class="name">MOUSE LOGITECH G203 RGB</h1>
                  ...
                  <div class="contenedor-detalles">
                      ...
                      <div class="stock-container info-container m-t-10 caracteristicas-cont">
                        ...
                        <div class="description-container m-t-20">
                          <ul class="caracteristicas">
                            <li>Marca: <span>LOGITECH</span></li>
                            <li>Ancho: <span>8</span></li>
                    ...
                    <div class="contenedor2">
                          ...
                          <div class="">
                            <div class="">
                              <div class="stock-box">
                                ...
                                <span class="value" id="stock-dis">100+</span>
                              </div>
                            </div>
                      ...
                      <div class="quantity-container info-container botones-detalles">
                        <div class="">
                          <a class="btn  btn-agregar" data-id="17"><i class="fa fa-shopping-cart inner-right-vs"></i> AGREGAR AL
                            CARRITO</a>
                        </div>
                        <div class="">
                ...
                <div class="tabs contenedor-descripcion" id="description">
                  ...
                  <div class="especificaciones-informacion tabs-content">
                    ...
                    <div class="informacion-producto tabs-panel " id="tab2">
                      <h3>MOUSE LOGITECH G203 RGB</h3>
                      <p>MOUSE LOGITECH G203 RGB: hasta 10 000 DPI y 125/1000Hz, Software: sí (configurar specs, macros,
