...
<head>
  ...
  <title>Replay | Audifono Gamer</title>
            ...
            <div id="divproductodetalle" class="row">
                  ...
                  <div id="owl-single-product">
                    <div class="single-product-gallery-item" id="slide1">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Audifonos/Audifono1/Frente.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Audifonos/Audifono1/Frente.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide2">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Audifonos/Audifono1/caja.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Audifonos/Audifono1/caja.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide3">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Audifonos/Audifono1/lado.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Audifonos/Audifono1/lado.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide4">
                      <a data-lightbox="image-1" data-title="Gallery"
                        href="../image/Tecnologia/Audifonos/Audifono1/micro.jpg">
                        <img class="img-responsive" alt="" src="../assets/images/blank.gif"
                          data-echo="../image/Tecnologia/Audifonos/Audifono1/micro.jpg" />
                      </a>
                    </div><!-- /.single-product-gallery-item -->
              ...
              <div class='col-sm-12 col-md-8 col-lg-8 product-info-block'>
                <div class="product-info">
                  <h1 class="name">Audífonos Gamer para Ps4 Pc Xbox</h1>
                  ...
                  <div class="contenedor-detalles">
                      ...
                      <div class="stock-container info-container m-t-10 caracteristicas-cont">
                        ...
                        <div class="description-container m-t-20">
                          <ul class="caracteristicas">
                            <li>1. SKU:<span> GE582EL05GCL6LPE</span></li>
                            <li>2. Modelo:<span> SDS</span></li>
                            <li>3. Color:<span> Negro</span></li>
                            <li>4. Garantía:<span>1año</span></li>
                    ...
                    <div class="contenedor2">
                      ...
                      <div class="price-container quantity-container info-container precio-cant">
                        <div>
                          ...
                          <div class="precio">
                            ...
                            <div class="price-box">
                              <span class="price-strike">S/.229.00</span>
                            </div>
                          </div>
                      ...
                      <div class="quantity-container info-container botones-detalles">
                        <div class="">
                          <a class="btn  btn-agregar" data-id="7"><i class="fa fa-shopping-cart inner-right-vs"></i> AGREGAR AL
                            CARRITO</a>
                        </div>
                        <div class="">
                  ...
                  <div class="especificaciones-informacion tabs-content">
                    ...
                    <div class="especificaciones tabs-panel active" id="tab1">
                      ...
                      <table class="caracteristicas">
                        <tr>
                          <td>1. Sonido perfecto:</td>
                          <td>Controlador de 50 mm de alta precisión, que le brinda un campo de sonido realista, sonido
                            claro, calidad de sonido impactante, capaz de varios juegos.</td>
                        </tr>
                        <tr>
                          <td>2. Diseño cómodo:</td>
                          <td>Estos auriculares ergonómicos para juegos utilizan almohadillas para los oídos súper
                            suaves, que se pueden usar cómodamente durante mucho tiempo, lo que los convierte en unos
                            auriculares excelentes para los jugadores.</td>
                        </tr>
                        <tr>
                          <td>3. Micrófono duradero y con cancelación de ruido:</td>
                          <td> El micrófono para juegos flexible de larga duración es muy sensible y duradero.</td>
                        </tr>
                        <tr>
                          <td>4. Excelente compatibilidad:</td>
                          <td>Adecuado para la mayoría de los dispositivos con puerto para auriculares / micrófono de
                            3,5 mm.</td>
                        </tr>
                        <tr>
                          <td>5. Diámetro del cuerno: </td>
                          <td>50 mm</td>
                        </tr>
                        <tr>
                          <td>Impedancia: </td>
                          <td>16-20 ohmios ± 15%</td>
                        </tr>
                        <tr>
                          <td>6.Sensibilidad:</td>
                          <td> 105, ± 3dB</td>
                        </tr>
                        <tr>
                          <td>7.Frecuencia:</td>
                        ...
                        <tr>
                          <td>8.Tamaño del micrófono: </td>
                          <td>6.0 * 2.7 mm</td>
                        </tr>
                        <tr>
                          <td>9.Sensibilidad del micrófono:</td>
                          <td>-42 ± 1dB</td>
                        </tr>
                        <tr>
                          <td>10.Impedancia del micrófono: </td>
                          <td>2,2 K ohmios</td>
                        </tr>
                      </table>
                    </div>
                    <div class="informacion-producto tabs-panel " id="tab2">
                      <h3>Audífonos Gamer para Ps4 Pc Xbox</h3>
                      <p>Estos auriculares ergonómicos para juegos utilizan almohadillas para los oídos súper suaves,
                        que se pueden usar cómodamente durante mucho tiempo, lo que los convierte en unos auriculares
                        excelentes para los jugadores.
                      </p>
