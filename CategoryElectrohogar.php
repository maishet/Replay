...
<head>
  ...
  <title>Replay.com | ElectroHogar</title>
    ...
    <div class="container">
      <div class="breadcrumb-inner">
        <ul class="list-inline list-unstyled">
          ...
          <li class='active'>ElectroHogar</li>
        </ul>
      </div>
      <!-- /.breadcrumb-inner -->
    </div>
            ...
            <div class="sidebar-filter">
              ...
              <div class="sidebar-widget">
                ...
                <div class="sidebar-widget-body">
                  <div class="accordion">
                    ...
                    <div class="accordion-group">
                      <div class="accordion-heading"> <a href="#" data-toggle="collapse" class="item_catg accordion-toggle collapsed" category="lavado"> Lavado </a> </div>
                      <!-- /.accordion-heading -->
                    ...
                    <div class="accordion-group">
                      <div class="accordion-heading"> <a href="#" data-toggle="collapse" class="item_catg accordion-toggle collapsed" category="refri"> Refrigeración </a> </div>
                      <!-- /.accordion-heading -->
              ...
              <div class="sidebar-widget">
                ...
                <div class="sidebar-widget-body m-t-10">
                  ...
                  <!-- /.price-range-holder -->
                  <a href="#" class="lnk btn btn-primary">Mostrar</a>
                </div>
                <!-- /.sidebar-widget-body -->
              </div>
              <!-- /.sidebar-widget -->
              ...
              <div class="tab-pane active">
                <div class="category-product" id="lista-productoscatg">
                  <div class="row productos-filtrar" id="itemContainer">
                    <!-- /.category-product controlador paginado-->
