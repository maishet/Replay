  ...
  <div style="background-color: #3D5C98;padding:5%; margin: 0 0 3%;"> 
	...
	<form class="register-form outer-top-xs" role="form">
		<div class="form-group " style="margin:1% 25%;">
		    ...
		    <input type="text" class="form-control unicase-form-control text-input" id="exampleOrderId1" style="margin: 4% 0%;border-radius: 15px;border: 1px solid #666666; ">
    ...
    <div style="text-align: center; ;">
      <button type="submit" class="btn-upper btn btn-primary checkout-page-button" style="margin:1% 25%;background-color:#3D5C98;padding: 0.7% 9%"><b>BUSCAR</b></button>
    </div>
